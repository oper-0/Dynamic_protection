...
if __name__=='__main__':
    ...
    w = QMainWindow()
    w.show()
    w.setCentralWidget(LoggerWidget(info_ico=QIcon(r'C:\Users\4NR_Operator_34\Favorites\chernika-34\dev\SW\normGSM\0\fuels-lubricants-DBMS\source\assets\icons\info_24.png'),
                                    error_ico=QIcon(r'C:\Users\4NR_Operator_34\Favorites\chernika-34\dev\SW\normGSM\0\fuels-lubricants-DBMS\source\assets\icons\error_24.png'),
                                    warn__ico=QIcon(r'C:\Users\4NR_Operator_34\Favorites\chernika-34\dev\SW\normGSM\0\fuels-lubricants-DBMS\source\assets\icons\warn_24.png')))
    app.exec()